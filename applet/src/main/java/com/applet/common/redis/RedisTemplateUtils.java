package com.applet.common.redis;
...
public class RedisTemplateUtils {
     ...
     * @return
     */
    public boolean expireTimeCustom(String key, long time, TimeUnit type) {
     ...
     * @return
     */
    public Set<Object> keysPattern(String key) {
        Set<Object> responseKey = null;
        try {
            responseKey = redisTemplate.keys(key + "*");
        } catch (Exception e) {
            LOGGER.error("keysPattern", e);
        }
        return responseKey;
    }
    ...
    /**
     * string ket存储，自定义时间类型
     *
     * @param key
     * @param value
     * @param time  时间小于等于0则无过期时间
     * @param type
     */
    public boolean setForTimeCustom(String key, Object value, long time, TimeUnit type) {
        try {
            if (time > 0) {
     ...
     * @param keyAndValue
     */
    public boolean batchSetIfAbsent(Map<String, Object> keyAndValue) {
        return redisTemplate.opsForValue().multiSetIfAbsent(keyAndValue);
    }
     ...
     * @return
     */
    public Map<Object, Object> getHashEntriesAll(String key) {
