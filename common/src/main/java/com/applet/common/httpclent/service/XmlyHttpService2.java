...
//import ai.zile.omp.content.domain.dto.AlbumFull;
//import ai.zile.omp.content.domain.dto.TrackFull;
//import ai.zile.omp.content.httpclient.XMLYParamsUtil;
//import ai.zile.omp.content.httpclient.xmlybase.BaseServiceResp;
...
//    }
//
//    public BaseServiceResp<AlbumFull> ALBUMS(Map<String, String> request) {
//        logger.info("[喜马拉雅]获取指定id集合的album列表...");
//        return coreGetHttp(AlbumFull.class, XmlyHttpServiceIdEnum.ALBUMS.getServiceId(), request);
//    }
//
//    public BaseServiceResp<AlbumFull> ALBUMS_ID(Map<String, String> request, String id) {
//        logger.info("[喜马拉雅]获取指定id的album...");
//        return coreGetHttp(AlbumFull.class, XmlyHttpServiceIdEnum.ALBUMS_ID.getServiceId().replace("{id}", id), request);
//    }
//
//    public BaseServiceResp<TrackFull> ALBUMS_ID_TRACKS(Map<String, String> request, String id) {
//        logger.info("[喜马拉雅]获取指定id专辑的音频列表...");
//        return coreGetHttp(TrackFull.class, XmlyHttpServiceIdEnum.ALBUMS_ID_TRACKS.getServiceId().replace("{id}", id), request);
//    }
//
//    public BaseServiceResp ANNOUNCERS_ID(Map<String, String> request, String id) {
...
//    }
//
//    public BaseServiceResp ANNOUNCERS(Map<String, String> request) {
//        logger.info("[喜马拉雅]获取指定id的主播列表...");
//        return coreGetHttp(JSONObject.class, XmlyHttpServiceIdEnum.ANNOUNCERS.getServiceId(), request);
//    }
//
//    public BaseServiceResp ANNOUNCERS_ID_ALBUMS(Map<String, String> request, String id) {
...
//    }
//
//    public BaseServiceResp ANNOUNCERS_ID_TOP_TRACKS(Map<String, String> request, String id) {
...
//    }
//
//    public BaseServiceResp ANNOUNCERS_ID_RELATED_ANNOUNCERS(Map<String, String> request, String id) {
//        logger.info("[喜马拉雅]获取指定id专辑的音频列表...");
...
//    }
//
//    public BaseServiceResp<TrackFull> TRACKS_ID(Map<String, String> request, String id) {
//        logger.info("[喜马拉雅]获取指定id的音频...");
//        return coreGetHttp(TrackFull.class, XmlyHttpServiceIdEnum.TRACKS_ID.getServiceId().replace("{id}", id), request);
//    }
//
//    public BaseServiceResp TRACKS(Map<String, String> request) {
//        logger.info("[喜马拉雅]获取指定id的音频列表...");
//        return coreGetHttp(JSONObject.class, XmlyHttpServiceIdEnum.TRACKS.getServiceId(), request);
//    }
//
//    public BaseServiceResp TRACKS_TRACK_SEQ(Map<String, String> request) {
...
//    }
//
//    public BaseServiceResp BROWSE_HOT_WORDS(Map<String, String> request) {
...
//    }
//
//    public BaseServiceResp BROWSE_RELATIVE_ALBUMS(Map<String, String> request) {
...
//    }
//
//    public BaseServiceResp<JSONObject> BROWSE_ALBUM_CATEGORIES(Map<String, String> request) {
...
//    }
//
//    public BaseServiceResp BROWSE_ANNOUNCER_CATEGORIES(Map<String, String> request) {
...
//    }
//
//    public BaseServiceResp BROWSE_RADIO_CATEGORIES(Map<String, String> request) {
...
//    }
//
//    public BaseServiceResp ALBUM_CATEGORIES_ID(Map<String, String> request, String id) {
...
//    }
//
//    public BaseServiceResp ANNOUNCER_CATEGORIES_ID(Map<String, String> request, String id) {
...
//    }
//
//    public BaseServiceResp RADIO_CATEGORIES_ID(Map<String, String> request, String id) {
...
//    }
//
//    public BaseServiceResp ALBUM_CATEGORIES_ID_TAGS(Map<String, String> request, String id) {
//        logger.info("[喜马拉雅]获取指定id的album...");
//        return coreGetHttp(JSONObject.class, XmlyHttpServiceIdEnum.ALBUM_CATEGORIES_ID_TAGS.getServiceId().replace("{id}", id), request);
//    }
//
//    public BaseServiceResp ALBUM_CATEGORIES_ID_ALBUMS(Map<String, String> request, String id) {
...
//    }
//
//    public BaseServiceResp RADIO_CATEGORIES_ID_RADIOS(Map<String, String> request, String id) {
...
//    }
//
//    public BaseServiceResp RADIOS_ID(Map<String, String> request, String id) {
...
//    }
//
//    public BaseServiceResp RADIOS(Map<String, String> request) {
//        logger.info("[喜马拉雅]获取指定ids的电台列表...");
//        return coreGetHttp(JSONObject.class, XmlyHttpServiceIdEnum.RADIOS.getServiceId(), request);
//    }
//
//    public BaseServiceResp RADIOS_ID_SCHEDULES(Map<String, String> request, String id) {
...
//    }
//
//    public BaseServiceResp RADIOS_ID_PLAYING_PROGRAM(Map<String, String> request, String id) {
...
//     * @return
//     */
//    private BaseServiceResp coreGetHttp(Class response, String serviceId, Map<String, String> request) {
...
//        BaseServiceResp baseServiceResp = JSON.parseObject(resultJson, BaseServiceResp.class);
//        logger.info("[喜马拉雅]BaseServiceResp-->{}：",baseServiceResp);
