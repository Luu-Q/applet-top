...
import com.applet.sms.scoreHandler.MemberScoreEnum;
...
public class MemberScoreDetailController {
    ...
    public ResultModel addMemberScore(@RequestBody MemberGainScoreReq req, BindingResult result){
        ...
        AbstractHandler contextInstance = handlerContext.getInstance(MemberScoreEnum.fromValue(req.getScoreRuleId()).getScoreCode());
    ...
    public static void main(String[] args) throws Exception {
        IClientProfile profile = DefaultProfile
                .getProfile("cn-beijing", "LTAITWiaMZ6SysPS", "sDcpapZl4BvY5qCGgyhHUyhZq6DZPB");
        DefaultProfile
        ...
        try{
            url = uploader.uploadFile("/it_soft/WechatIMG16.jpeg");
        }catch (Exception e){
            e.printStackTrace();
        }
